...
On 2026-09-11, production server `0.3.3` returned 32 tools and the v3 UI resource; its SHA-256 matched the tested local build. Protected reads returned 401 without authorization and all seven readiness checks passed. The initial implementation passed 776 tests; the final compatibility patch passed 49 focused tests and typecheck/build.
