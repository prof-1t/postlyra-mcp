...
**Кандидат в релиз 0.2 (`0.2.0-rc.1`).** Новый набор инструментов ожидает выкладки и живой проверки в ИИ-клиентах. Production endpoint может пока возвращать прежние базовые инструменты. Примеры расписания, управления публикациями и передачи медиа ниже описывают кандидат в релиз; перед использованием проверьте фактический список инструментов сервера. Прохождение полного сценария ни в одном из пяти описанных клиентов пока не заявляется.
